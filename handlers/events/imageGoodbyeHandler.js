...
module.exports = {
    ...
    async execute(member) {
        ...
        try {
            ...
            const textY_Header = boxY + 80;
            const textY_Name = boxY + 180;
            const textY_Sub = boxY + 280;

            // 1. "GÜLE GÜLE"
            ctx.font = 'bold 45px sans-serif';
            ctx.fillStyle = '#ff6b6b'; // Pembe/Kırmızı
            ctx.shadowColor = "rgba(0,0,0,1)";
            ctx.shadowBlur = 5;
            ctx.fillText("GÜLE GÜLE... 🥺", centerX, textY_Header);
            ...
            ctx.shadowBlur = 0;
            ctx.fillText("Kendine çok iyi bak! 👋", centerX, textY_Sub);
