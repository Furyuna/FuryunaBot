...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (targetMember.roles.cache.has(localConfig.roles.unregistered)) {
            ...
            return interaction.reply({ content: localConfig.messages.zatenKayitsiz(targetMember.id, roleName), ephemeral: true });
        }
        ...
        await interaction.reply({ content: localConfig.messages.kayitSilindi(targetMember.id, interaction.user.id) });
    }
};