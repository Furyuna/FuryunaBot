...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (targetMember.roles.cache.has(localConfig.roles.verifiedMember)) {
            ...
            return interaction.reply({ content: localConfig.messages.zatenDogrulanmis(targetMember.id, roleName), ephemeral: true });
        }
        ...
        await interaction.reply({ content: localConfig.messages.dogrulamaBasarili(targetMember.id, interaction.user.id) });
    }
};